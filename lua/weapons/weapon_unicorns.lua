SWEP.PrintName			= "Unicorn Launcher" -- This will be shown in the spawn menu, and in the weapon selection menu
SWEP.Author			= "Jet" -- These two options will be shown when you have the weapon highlighted in the weapon selection menu
SWEP.Instructions		= "Left Click to launch the unicorns!"
...
SWEP.IconOverride = 'materials/weapons/weapon_unicorns.jpg'

SWEP.ShootSound = Sound("/garrysmod/balloon_pop_cute.wav")

SWEP.HoldType = "shotgun"
SWEP.ViewModelFOV = 70
SWEP.ViewModelFlip = false
SWEP.UseHands = false
SWEP.ViewModel = "models/weapons/c_models/c_balloonicornflame/c_balloonicornflame.mdl"
SWEP.WorldModel = "models/weapons/c_models/c_balloonicornflame/c_balloonicornflame.mdl"
SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["weapon_bone"] = { scale = Vector(0.813, 0.813, 0.813), pos = Vector(6.852, -5.742, -12.037), angle = Angle(1.11, 7.777, -10) }
}

SWEP.VElements = {
	["models/weapons/c_models/c_balloonicornflame/c_balloonicornflame.mdl"] = { type = "Model", model = "models/weapons/c_models/c_balloonicornflame/c_balloonicornflame.mdl", bone = "weapon_bone", rel = "", pos = Vector(0, 0, 0), angle = Angle(82.986, -3.507, -75.974), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["unicornFlamethrower"] = { type = "Model", model = "models/weapons/c_models/c_balloonicornflame/c_balloonicornflame.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1, -2), angle = Angle(-22.209, -5.844, -150), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	self:LaunchUnicorn( "models/gmod_tower/balloonicorn_nojiggle.mdl" )
end

-- A custom function we added. When you call this the player will fire a chair!
function SWEP:LaunchUnicorn( model_file )
	...
	timer.Simple( 1, function() ent:Ignite(2) end)
	timer.Simple( 1, function() ent:SetColor( Color(0,0,0,255) ) end)
